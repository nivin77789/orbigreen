      ...
      <div className="relative z-10 mx-auto max-w-[1280px] px-6 lg:px-10">
        <div className="mb-10 sm:mb-12">
          <motion.div
            ...
            className="max-w-xl"
          >
            <h2 className="text-[clamp(1.9rem,3.2vw,2.75rem)] font-semibold leading-[1.08] tracking-tight text-primary">
              Industries We Serve
            </h2>
            <p className="mt-3 text-[17px] lg:text-[18px] leading-relaxed text-primary/60">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center gap-2.5 sm:gap-3">
                ...
                <div className="min-w-0">
                  <h3 className="text-[14px] lg:text-[15px] font-semibold leading-tight tracking-tight text-primary sm:text-[15px] lg:text-[16px]">
                    {industry.name}
                  </h3>
                  <p className="industry-card__tagline mt-1 text-[12px] lg:text-[13px] leading-snug text-primary/52 sm:text-[13px] lg:text-[14px]">
                    {industry.tagline}
                  </p>
                </div>
              </div>
