      ...
      <main className="pt-28">
        <section className="relative mx-auto max-w-[1280px] px-6 pb-16 lg:px-10">
          ...
          >
            <Link
              to="/services"
              className="inline-flex items-center gap-2 text-[12px] lg:text-[13px] font-semibold uppercase tracking-[0.2em] text-primary/50 transition-colors hover:text-primary"
            >
              ← All Services
            </Link>
          </motion.div>
          ...
          <div className="relative mt-8 grid items-center gap-12 lg:grid-cols-2">
            ...
            >
              ...
              <p className="mt-5 max-w-xl text-[16px] lg:text-[17px] leading-relaxed text-primary/70">
        ...
        <section className="border-t border-primary/10 bg-white section-spacing">
          <div className="mx-auto max-w-[1280px] px-6 lg:px-10">
            ...
            <div className="mt-10 grid gap-6 lg:grid-cols-2">
              ...
              >
                <h3 className="text-[18px] lg:text-[19px] font-semibold tracking-tight text-primary">{service.focusLabel}</h3>
                <ul className="mt-6 space-y-3">
                  {service.items.map((item) => (
                    <li
                      key={item}
                      className="flex items-start gap-3 text-[14px] lg:text-[15px] leading-relaxed text-primary/75"
                    >
                      <span
              ...
              <motion.div
                ...
                className="glass-card-light rounded-3xl p-8"
              >
                <h3 className="text-[18px] lg:text-[19px] font-semibold tracking-tight text-primary">{service.partnerTitle}</h3>
                <p className="mt-4 text-[15px] lg:text-[16px] leading-relaxed text-primary/70">{service.partnerDescription}</p>
                <blockquote className="mt-8 border-l-2 border-secondary pl-5 text-[15px] lg:text-[16px] italic leading-relaxed text-primary/80">
                  "{service.quote}"
                </blockquote>
              </motion.div>
            </div>
