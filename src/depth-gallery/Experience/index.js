...
class Experience {
  ...
  setContainer(container) {
    this.container = container
    this.gallery.setContainer(container)
    this.label.setContainer(container)
  }
  ...
  updateFrameTextTone(planeBlendData) {
    ...
    this.container.classList.toggle('frame-text-dark', shouldUseDarkText)
  }
  ...
  dispose() {
    ...
    this.container?.classList.remove('frame-text-dark')
